...
# 1. DESKTOP		#
#####################
# Set the default desktop background. Use a file that already exists on the Mac, or
# use curl to download your own.
# DesktopPicturePath="/Library/Desktop Pictures/Custom/default.jpg" # adjust to fit file format
# mkdir -p $(dirname "$DesktopPicturePath")
# curl -o "$DesktopPicturePath" http://URL-TO-YOUR-DESKTOP-IMAGE
...
# 2. INSTALL APPS	#
#####################
# Use Installomator to install a list of standard items:
# source:
# https://github.com/Installomator/Installomator/blob/main/MDM/App-loop%20script.sh

# Enter the software labels to install separated with spaces
# list of available software: https://github.com/Installomator/Installomator/blob/main/Labels.txt

# EDIT THIS
whatList="microsoftteams firefox bravebrowser cyberduck vlc signal" 
