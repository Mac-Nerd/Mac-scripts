...
# Set a custom NTP server, and set the Mac to sync the clock automatically. Useful if the default NTP server (time.apple.com) is unreachable due to firewall rules.
...
TIMEZONE=[SELECT A TIMEZONE ENTRY]

# Valid settings for timezone entry:
#  Africa/Abidjan
#  Africa/Accra
#  Africa/Addis_Ababa
#  Africa/Algiers
